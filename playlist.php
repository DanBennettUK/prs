...
<html>
    ...
    <div id="logo"></div>
        <!-- The Form! -->
            <form method="post" class="plform" action="<?php $_PHP_SELF ?>">
                <table width="400" border="0" cellspacing="1" cellpadding="2">
                    <tr>
                        <td class="heading">Artist</td>
                        <td><input name="artist" type="text" id="artist" maxlength="254"></td>
                    </tr>
                    <tr>
                        <td class="heading">Title</td>
                        <td><input name="title" type="text" id="title" maxlength="254"></td>
                    </tr>
                    <tr>
                        <td class="heading">Presenter</td>
                        <td><div name="presenter" id="presenter" class="input"> <?php echo $presenter; ?></select></td>
                    </tr>
                    <tr>
                        <td width="100"> </td>
	...
	/* Get the data and pagse it hopefully*/
        ...
        if (isset($_POST['submitnumberentries'])) {
           ...
           // or die('cannot show data from '.$table.'with '.$numberofentries.' enrties');
            ...
            $result2 = mysql_query('SELECT artist, title, timeplayed FROM '.$table.' WHERE presenter = "'.$presenter.'" ORDER BY id DESC LIMIT '.$start_from.',50') 
            or die('cannot show data from '.$table);
        }
        }
