...
<tr>
<!-- <td bgcolor="#FFFFFF"><a href="exportpres.php?presenter='.urlencode($rows['presenter']).'\'" onclick="return confirm('Export data for this presenter?')"><?php echo $rows['presenter']; ?></a></td> -->
<?php echo '<td style="cursor:hand" bgcolor="#FFFFFF" onclick="window.location.href=\'exportpres.php?presenter='.urlencode($rows['presenter']).'\'">',$rows['presenter'],'</td>';?>

<td bgcolor="#FFFFFF"><a href="delete.php?id=<?php echo $rows['presenter']; ?>" onclick="return confirm('Are you sure?')">Delete</a></td>
</tr>
...
<form method="post" class="presaddform" action="<?php $_PHP_SELF ?>">
